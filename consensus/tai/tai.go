...
func (t *Tai) Seal(chain consensus.ChainReader, block *types.Block, results chan<- *types.Block, stop <-chan struct{}) error {
	header := block.Header()
...
func (t *Tai) Close() error {
	return nil
}
func (c *Tai) SealHash(header *types.Header) common.Hash {
